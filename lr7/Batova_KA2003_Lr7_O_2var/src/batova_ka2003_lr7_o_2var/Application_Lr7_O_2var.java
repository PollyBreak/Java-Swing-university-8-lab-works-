 ...
 */
package batova_ka2003_lr7_o_2var;

/**
 *
 * @author batov
 */
public class Application_Lr7_O_2var extends javax.swing.JFrame {
    String[] names = new String[10]; //объявление массива
    public Application_Lr7_O_2var() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String Input = (jTextField1.getText ()); //записываем в строку названия всех команд
        names = Input.split(",");//записываем название команд в массив, разбивая строку запятыми
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Application_Lr7_O_2var.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Application_Lr7_O_2var().setVisible(true);
            }
        });
    }
